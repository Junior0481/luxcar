  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-surface-elevated text-card-foreground z-modal fixed flex h-auto flex-col border-border shadow-lux-lg backdrop-blur-md",
        ...
        {...props}
      >
        <div className="bg-muted mx-auto mt-4 hidden h-1.5 w-[88px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
